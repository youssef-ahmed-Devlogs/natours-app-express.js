...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieW91c3NlZjI3IiwiYSI6ImNsYWd1dTAyYzA1ZWMzcG1xeDg5NzdieWEifQ.gEB7xKqw0pt7VNodaMd2wQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(url),
              data: data
            });
          case 4:
            res = _context.sent;
            if (res.data.status == 'success') (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " updated successfully!"));
            _context.next = 11;
            break;
          case 8:
            _context.prev = 8;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Lf0MxHPYhKi5iJJxhSPbNdzDEWPii1TArM8KP1LQG15sXasyYSMifIpFuTzyOHPo6BR140LBzswwff2nswBY4Dw00PjHoyxgh');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    var btnOldText = e.target.textContent;
